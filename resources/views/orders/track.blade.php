...
@section('content')
    <div class="space-y-6">
        <div class="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div class="badge badge-outline">{{ $order->order_number }}</div>
        </div>
        ...
        <div class="steps steps-vertical w-full rounded-box border border-base-300 bg-base-100 p-6 lg:steps-horizontal">
